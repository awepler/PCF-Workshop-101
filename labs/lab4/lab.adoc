...
. If you don't have one already running, start a log tail for `spring-music`.  Alternatively, you could view the logs using the papertrail app.
+
----
$ cf logs spring-music
----
...
Stopping app spring-music in org TELCO / space gammon as admin...
OK
----
...
----
$ cf events spring-music
Getting events for app spring-music in org TELCO / space gammon as admin...
...
Starting app spring-music in org TELCO / space gammon as admin...
...
Showing health and status for app srping-music in org TELCO / space gammon as admin...
OK
